 ...
 * The poster carries all exhibition information (title, artist, medium, year,
 * description), so this entry deliberately holds just the image and an
 * optional gallery link. Replacing the exhibition = replacing the image.
 */
